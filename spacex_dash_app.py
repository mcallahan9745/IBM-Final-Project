...
def get_pie_chart(entered_site):
    if entered_site == 'All Sites':
        ...
        title = 'Success Count for ' + str(entered_site))
    return fig
...
def get_scatterplot(launch_site, payload_mass):
    ...
    if launch_site == 'All Sites':
        fig = px.scatter(data, x = 'Payload Mass (kg)', y = 'class', color = 'Booster Version Category',
                title = 'Payload and Success Rate Correlation for All Sites')
    else:
        data = spacex_df[spacex_df['Launch Site'] == str(launch_site)]
        fig = px.scatter(data, x ='Payload Mass (kg)', y = 'class', color = 'Booster Version Category',
                title = 'Payload and Success Rate Correlation for ' + str(launch_site))
    return(fig)
